...
[[nodiscard]] GLuint create_shader(GLenum shaderType);
void set_shader_source(GLuint shader, const char* shaderSource);
void compile_shader(GLuint shader);
[[nodiscard]] bool get_shader_compile_status(GLuint shader);
...
[[nodiscard]] bool get_program_link_status(GLuint program);
