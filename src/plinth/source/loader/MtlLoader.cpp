...
[[nodiscard]]
std::pair<std::string_view, std::string_view> split_keyword(std::string_view line) {
...
[[nodiscard]]
std::string resolve_texture_path(std::string_view raw, const std::filesystem::path& baseDir) {
...
[[nodiscard]]
bool parse_diffuse_color(std::string_view operand, std::array<float, 4>& color) {
